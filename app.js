...
// 1003/URLA Section 5a & 5b — triggers match the official form exactly
const DEC_PROPERTY={en:[
  {id:"occupyProperty",q:"Will you occupy the property as your primary residence?",trigger:{val:"Yes",show:[
    {id:"priorProperty",q:"Have you had an ownership interest in another property in the last 3 years?",trigger:{val:"Yes",show:[
      {id:"priorPropertyType",q:"What type of property did you own?",type:"choice",opts:["Primary Residence","FHA Secondary Residence","Second Home","Investment Property"]},
      {id:"titleHeld",q:"How did you hold title?",type:"choice",opts:["By Yourself","Jointly with Spouse","Jointly with Another Person"]}
    ]}}
  ]}},
  ...
  {id:"borrowedFunds",q:"Are you borrowing any money for this transaction (e.g., closing costs or down payment) not disclosed on this application?",trigger:{val:"Yes",show:[
    {id:"borrowedAmount",q:"What is the amount of this money?",type:"text",ph:"$ Amount"}
  ]}},
  ...
  {id:"borrowedFunds",q:"\u60a8\u662f\u5426\u4e3a\u6b64\u6b21\u4ea4\u6613\u501f\u6b3e\uff08\u5982\u9996\u4ed8\u6216\u8fc7\u6237\u8d39\uff09\uff0c\u4e14\u672a\u5728\u6b64\u7533\u8bf7\u4e2d\u62ab\u9732\uff1f",trigger:{val:"\u662f",show:[
    {id:"borrowedAmount",q:"\u8fd9\u7b14\u8d44\u91d1\u7684\u91d1\u989d\u662f\u591a\u5c11\uff1f",type:"text",ph:"$ \u91d1\u989d"}
  ]}},
...
const DEC_FINANCIAL={en:[
  ...
  {id:"bankruptcy",q:"Have you declared bankruptcy within the past 7 years?",trigger:{val:"Yes",show:[
    {id:"bankruptcyType",q:"Identify the type(s) of bankruptcy:",type:"multicheck",opts:["Chapter 7","Chapter 11","Chapter 12","Chapter 13"]}
  ]}}
],zh:[
  ...
  {id:"bankruptcy",q:"\u8fc7\u53bb7\u5e74\u662f\u5426\u5ba3\u5e03\u8fc7\u7834\u4ea7\uff1f",trigger:{val:"\u662f",show:[
    {id:"bankruptcyType",q:"\u8bf7\u9009\u62e9\u7834\u4ea7\u7c7b\u578b\uff1a",type:"multicheck",opts:["\u7b2c7\u7ae0\u7834\u4ea7","\u7b2c11\u7ae0\u7834\u4ea7","\u7b2c12\u7ae0\u7834\u4ea7","\u7b2c13\u7ae0\u7834\u4ea7"]}
  ]}}
]};
...
function getSteps(){
  ...
  if(lang==='en'){
    ...
    if(isW2){
      ...
      if(needsPrevEmployer(answers.duration)){s.push({id:"prevEmployerName",q:"Previous employer name?",type:"text",ph:"Previous company",req:true});s.push({id:"prevPosition",q:"Previous position / title?",type:"text",ph:"e.g. Sales Associate",req:true});s.push({id:"prevDuration",q:"How long at previous employer?",type:"duration",req:true});}
    }
    if(isSE){
      ...
      if(needsPrevEmployer(answers.duration)){s.push({id:"prevEmployerName",q:"Previous employer/business name?",type:"text",ph:"Previous company",req:true});s.push({id:"prevPosition",q:"Previous position / title?",type:"text",ph:"Position",req:true});s.push({id:"prevDuration",q:"How long at previous employer?",type:"duration",req:true});}
    }
    if(hasCo&&!skip){
    ...
    if(isW2){
      ...
      if(needsPrevEmployer(answers.duration)){s.push({id:"prevEmployerName",q:"\u524d\u96c7\u4e3b\u540d\u79f0\uff1f",type:"text",ph:"\u524d\u516c\u53f8\u540d\u79f0",req:true});s.push({id:"prevPosition",q:"\u524d\u804c\u4f4d\uff1f",type:"text",ph:"\u804c\u4f4d",req:true});s.push({id:"prevDuration",q:"\u5728\u524d\u96c7\u4e3b\u5de5\u4f5c\u591a\u957f\u65f6\u95f4\uff1f",type:"duration",req:true});}
    }
    if(isSE){
      ...
      if(needsPrevEmployer(answers.duration)){s.push({id:"prevEmployerName",q:"\u524d\u96c7\u4e3b/\u4f01\u4e1a\u540d\u79f0\uff1f",type:"text",ph:"\u524d\u516c\u53f8\u540d\u79f0",req:true});s.push({id:"prevPosition",q:"\u524d\u804c\u4f4d\uff1f",type:"text",ph:"\u804c\u4f4d",req:true});s.push({id:"prevDuration",q:"\u5728\u524d\u96c7\u4e3b\u5de5\u4f5c\u591a\u957f\u65f6\u95f4\uff1f",type:"duration",req:true});}
    }
    if(hasCo&&!skip){
...
function renderDecSection(store,storeVar,decList,yesLabel,noLabel,isPurch){
  ...
  for(var di=0;di<decList.length;di++){
    ...
    // Encode labels for safe inline onclick
